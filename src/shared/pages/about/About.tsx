      ...
      <section className="relative px-6 lg:px-8 py-24 bg-gradient-to-b from-green-50 to-white">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-6">
            Transformando el
            <span className="text-green-600"> futuro agrícola</span> de Colombia
          </h1>

          <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            En AgriCapital creemos que cada productor merece acceso a
            financiamiento justo y oportuno. Combinamos tecnología de punta con
            conocimiento profundo del sector para democratizar el crédito
            agrícola.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="border-0 shadow-lg p-8">
              ...
              <CardContent className="text-center">
                <CardDescription className="text-lg text-gray-600 leading-relaxed">
                  Ser la plataforma líder de financiamiento agrícola en América
                  Latina, impulsando el crecimiento sostenible del sector y
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Utilizamos inteligencia artificial, machine learning y análisis
                de big data para evaluar el riesgo crediticio de manera más
                precisa y justa, considerando las particularidades del sector
                agrícola.
              </p>
